...
/* Definitions for CAN_2 */
osThreadId_t CAN_2Handle;
const osThreadAttr_t CAN_2_attributes = {
  .name = "CAN_2",
  .stack_size = 1024 * 4,
...
int main(void)
{
  ...
  /* creation of CAN_2 */
  CAN_2Handle = osThreadNew(CAN_2_RUN, NULL, &CAN_2_attributes);
...
void vApplicationIdleHook( void )
{
	...
	if(UARTRXcmd[0]==0x02)
  {
		//UARTRXcmd[0]=0x00;
		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_0,GPIO_PIN_RESET);
		vTaskResume(CAN_2Handle);
		xTaskNotifyGive(CAN_2Handle);
	}
}
/* USER CODE END 4 */
